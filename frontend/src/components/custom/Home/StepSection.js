    ...
    return (
        <div className="container mt-12 z-0">
            <div className="px-8 my-8 md:px-16 md:my-16">
                ...
                <div className="animation_wrapper-chain grid grid-rows-5 lg:grid-rows-none lg:grid-cols-5 items-center step-container content-center text-center mt-16 w-full">
                    {stap.map((stap, index) => (
